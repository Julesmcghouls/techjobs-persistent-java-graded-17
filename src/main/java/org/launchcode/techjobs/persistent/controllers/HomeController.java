...
public class HomeController {
    // Add a employerRepository, skillRepository, jobRepository field annotated with @Autowired
    @Autowired
	...
	model.addAttribute("title", "Add Job");
        ...
        //pass employer data from employerRepository
        model.addAttribute("employers", employerRepository.findAll());
        //pass skills data from skillRepository
